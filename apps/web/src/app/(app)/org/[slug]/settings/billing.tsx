          ...
          <Table>
            ...
            <TableBody>
              <TableRow>
                ...
                <TableCell className="text-right">
                  {numberToCurrency(billing.projects.price)} (
                  {numberToCurrency(billing.projects.unit)}) each
                </TableCell>
              </TableRow>
              ...
              <TableRow>
                ...
                <TableCell className="text-right">
                  {numberToCurrency(billing.seats.price)} (
                  {numberToCurrency(billing.seats.unit)}) each
                </TableCell>
              </TableRow>
            </TableBody>
            <TableFooter>
              <TableRow>
                ...
                <TableCell className="text-right">
                  {numberToCurrency(billing.total)}
                </TableCell>
              </TableRow>
            </TableFooter>
          </Table>
